...
<body style="width: 100%; margin-left: 0%; font-family: 'Barlow Condensed Regular'; font-size: 0.9rem;">
	...
	<div>
		...
		<div>
			...
			@php $sum_before_voucher = 0; @endphp
			@foreach($order->cart->couture_variations as $article)
			@if($article->name == 'voucher')
				<div style="position: relative; font-family: 'Barlow Condensed Medium'; height: 30px; border-bottom: solid gray 1px;">
					<div style="position: absolute; width: 40%; top: 0; left: 0;">
				...
				@php $sum_before_voucher += $article->pivot->value * $article->pivot->articles_number; @endphp
			@else
				<div style="position: relative; font-family: 'Barlow Condensed Medium'; height: 30px; border-bottom: solid gray 1px;">
					<div style="position: absolute; width: 40%; top: 0; left: 0;">
					...
					@php $sum_before_voucher += $article->creation->price * $article->pivot->articles_number; @endphp
				</div>
				@if($article->pivot->with_extra_article)
				<div style="position: relative; font-family: 'Barlow Condensed Regular'; height: 30px; border-bottom: solid gray 1px;">
					<div style="position: absolute; width: 40%; top: 0; left: 0;">
						+ Coussin additionnel
					</div>
					<div style="position: absolute; width: 15%; top: 0; left: 40%;">
					...
					@php $sum_before_voucher += 10 * $article->pivot->articles_number; @endphp
				</div>
				@endif
				...
				<div style="position: relative; font-family: 'Barlow Condensed Regular'; height: 30px; border-bottom: solid gray 1px;">
					...
					@php $sum_before_voucher += ($article->pivot->with_wrapping * 5 + $article->pivot->with_card * 3) * $article->pivot->articles_number; @endphp
				</div>
				@endif
			@endif
			@endforeach

			<div style="position: relative; font-family: 'Barlow Condensed Regular'; height: 30px; border-bottom: solid gray 1px; width: 60%; margin-left: 40%;">
			...
			<div style="position: relative; font-family: 'Barlow Condensed Regular'; height: 30px; border-bottom: solid gray 1px; width: 60%; margin-left: 40%;">
				...
				<div style="position: absolute; width: 25%; top: 0; left: 75%;">
					{{ number_format(max(0, $sum_before_voucher - $voucher_discount), 2) }}&euro;
				</div>
			</div>
