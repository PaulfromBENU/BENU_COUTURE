<section class="w-1/2 m-auto text-center return service-panel" id="services-return">
	...
	<div class="text-center return__link">
		<a href="{{ route('client-service', ['locale' => app()->getLocale(), 'page' => 'contact']) }}" class="btn-couture m-auto">
			Nous contacter pour un retour
		</a>
	</div>
</section>