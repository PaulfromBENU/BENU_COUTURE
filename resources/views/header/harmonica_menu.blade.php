				...
				<div class="harmonica-menu__content__col__open harmonica-menu__content__col__open--village">
					...
					<div class="harmonica-menu__content__col__open__desc flex flex-col justify-center">
						...
						<div class="text-center">
							<a @if(app()->getLocale() == 'lu') href="https://benu.lu" @else href="https://benu.lu/{{ app()->getLocale() }}" @endif target="_blank" rel="noreferrer" class="btn-trans btn-trans--b-white btn-hover-village">
			...
			<div class="harmonica-menu__content__col harmonica-menu__content__col--sis">
				...
				<div class="harmonica-menu__content__col__open harmonica-menu__content__col__open--sis">
					...
					<div class="harmonica-menu__content__col__open__desc flex flex-col justify-center">
						...
						<div class="text-center">
							<a @if(app()->getLocale() == 'lu') href="https://benu.lu" @else href="https://benu.lu/{{ app()->getLocale() }}" @endif target="_blank" rel="noreferrer" class="btn-trans btn-trans--b-white btn-hover-sis">{!! __('header.discover-sis') !!}</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="harmonica-menu__content__col harmonica-menu__content__col--sloow">
				...
				<div class="harmonica-menu__content__col__open harmonica-menu__content__col__open--sloow">
					...
					<div class="harmonica-menu__content__col__open__desc flex flex-col justify-center">
						...
						<div class="text-center">
							<a href="https://sloow.benu.lu/{{ app()->getLocale() }}" target="_blank" rel="noreferrer" class="btn-trans btn-trans--b-white btn-hover-sloow">{!! __('header.discover-sloow') !!}</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="harmonica-menu__content__col harmonica-menu__content__couture">
				...
				<div class="harmonica-menu__content__col__open harmonica-menu__content__col__open--couture">
					...
					<div class="harmonica-menu__content__col__open__desc flex flex-col justify-center">
						...
						<div class="text-center">
							<a href="https://couture.benu.lu/{{ app()->getLocale() }}" target="_blank" rel="noreferrer" class="btn-trans btn-trans--b-white btn-hover-couture">{!! __('header.discover-couture') !!}</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="harmonica-menu__content__col harmonica-menu__content__reuse">
				...
				<div class="harmonica-menu__content__col__open harmonica-menu__content__col__open--reuse">
					...
					<div class="harmonica-menu__content__col__open__desc flex flex-col justify-center">
						...
						<div class="text-center">
							<a @if(app()->getLocale() == 'de') href="https://www.benureuse.lu" @else href="https://www.benureuse.lu/{{ app()->getLocale() }}" @endif target="_blank" rel="noreferrer" class="btn-trans btn-trans--b-white btn-hover-reuse">{!! __('header.discover-reuse') !!}</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="harmonica-menu__content__col harmonica-menu__content__lasa">
				...
				<div class="harmonica-menu__content__col__open harmonica-menu__content__col__open--lasa">
					...
					<div class="harmonica-menu__content__col__open__desc flex flex-col justify-center">
						...
						<div class="text-center">
							<a @if(app()->getLocale() == 'lu') href="https://benu.lu" @else href="https://benu.lu/{{ app()->getLocale() }}" @endif target="_blank" rel="noreferrer" class="btn-trans btn-trans--b-white btn-hover-lasa">{!! __('header.discover-lasa') !!}</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="harmonica-menu__content__col harmonica-menu__content__design">
				...
				<div class="harmonica-menu__content__col__open harmonica-menu__content__col__open--design">
					...
					<div class="harmonica-menu__content__col__open__desc flex flex-col justify-center">
						...
						<div class="text-center">
							<a @if(app()->getLocale() == 'lu') href="https://benu.lu" @else href="https://benu.lu/{{ app()->getLocale() }}" @endif target="_blank" rel="noreferrer" class="btn-trans btn-trans--b-white btn-hover-design">{!! __('header.discover-design') !!}</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="harmonica-menu__content__col harmonica-menu__content__col--break">
				...
				<div class="harmonica-menu__content__col__open harmonica-menu__content__col__open--break">
					...
					<div class="harmonica-menu__content__col__open__desc flex flex-col justify-center">
						...
						<div class="text-center">
							<a @if(app()->getLocale() == 'lu') href="https://benu.lu" @else href="https://benu.lu/{{ app()->getLocale() }}" @endif target="_blank" rel="noreferrer" class="btn-trans btn-trans--b-white btn-hover-break">{!! __('header.discover-break') !!}</a>
						</div>
					</div>
				</div>
			</div>
