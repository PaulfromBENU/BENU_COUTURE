<div>
    ...
    @if($news_count > $max_number)
    <div class="text-center mb-10">
        <button class="btn-couture-plain btn-couture-plain--fit btn-couture-plain--dark-hover" wire:click="showMore">{{ __('news.show-more') }}</button>
    </div>
    @endif
</div>
